...
{ 
    ...
    // the index of the buffer where the consumer will consume a process 
    ...
    // for multi consumers if the index is already created it will take its current value otherwise it will create index
    if(index != -1)
    {
        semun.val = 0; /* initial value of the semaphore, Binary semaphore */
